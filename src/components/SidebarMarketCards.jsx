      ...
      {markets.map((m) => (
        ...
        >
          ...
          <div className="flex gap-2">
            <button disabled className="flex-1 py-1 rounded-full text-[11px] bg-white/15 text-white/50">
              YES
            </button>
            <button disabled className="flex-1 py-1 rounded-full text-[11px] bg-black/20 text-white/50">
              NO
            </button>
          </div>
        </div>
